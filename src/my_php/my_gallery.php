...
<div class="row">
  ...
  <h2 align="right">My Gallery<h2>
    <div class="card">
      <div class="card-header">
        <div class="media-left">
              <figure class="image is-48x48">
              <img src="<?php echo $profile_pic?>" alt="Profile_pic" draggable="false">
            </figure>
          </div>
          <div class="media-content">
          <p class="title is-4"><font color="#3B5998"><?php echo $fname." ".$lname?></font></p>
            <p class="subtitle is-6"><font color="#3B5998"><?php echo "@".$login ?></font>
            <p class="subtitle is-6"><font color="#3B5998"><?php echo $time?></font></p>
            </p>
          </div>
      </div>
      <div class="card-body">
    ...
    {
      if ($i == $currentpage)
        echo '<a class="active" href="my_gallery.php?page='.$i.'">'.$i.'</a>';
      else
        echo '<a href="my_gallery.php?page='.$i.'">'.$i.'</a>';
